...
// core components
import HeaderLinks from "../../components-tim/Header/HeaderLinks.jsx";
...
class Sidebar extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            openOperations:this.activeRoute("/operations"),
            opencashbox:this.activeRoute("/cashbox"),
            opendefault:this.activeRoute("/default"),
            openadmin:this.activeRoute("/admin"),
            openemin:this.activeRoute("/admin2"),
            openkassa:this.activeRoute("/admin3"),
    ...
    activeRoute(routeName) {
        ...
        // console.log('routeName: ', routeName, '[', this.props.location.pathname, ']');
    ...
    render() {
        ...
        let user = (<div className={userWrapperClass}>
            <div className={photo}>
                <img src={nophoto} className={classes.avatarImg} alt="..."/>
            </div>
                ...
                <ListItem className={classes.item + " " + classes.userItem}>
                    ...
                    >
                        <ListItemText
                            primary={""}
                            secondary={
                                <b className={caret + " " + classes.userCaret + " " +
        ...
        let links = (<List className={classes.list}>
            {routes.map((prop, key) => {
                if (prop.redirect) {
                    return null;
                }
        ...
        let brand = (<div className={logoClasses}>
