...
import ItemCardAmountForm from "./Trans1Form";
...
class Trans1 extends CoreComponent {
    ...
    //     console.log("reng",props);
    //     const color = this.state.tableData[1].fakturaType==='Aldım' ? "blue" : "";
                ...
                <Card style={{marginTop: "0px"}}>
                    ...
                    <CardBody>
                        ...
                        <DataGrid
                            ...
                            // rowRender={this.RowRenderer(this.state.tableData)}
