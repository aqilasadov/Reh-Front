...
import ItemCardAmountForm from "./TransDigerV2Form";
...
import TransferFilter from "./TransferFilterV2";
                    ...
                    <CardBody>
                        ...
                        <DataGrid
                            ...
                            <Column dataField={'id'} caption={''}
                                    cellRender={row => {
console.log('row.data.updateId',row.data.updateId);
    ...
    handleOnChange = name => event => {
        ...
        else if (name === 'fakturaType' || name === 'item' || name === 'unitsetGrp' || name === 'client' || name === 'client2' || name === 'branch')
            val = event;
