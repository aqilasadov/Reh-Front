...
import KassaToKassaForm from "./KassaToKassaForm";
...
class KassaToKassa extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            dataLoaded: false,
    ...
    handleOnChange = name => event => {
        let val;
        if (name === 'kassaType' || name === 'kassaBank' || name === 'kassaBank2' || name === 'kbType' || name === 'kbType2' || name === 'client' || name === 'faktura' || name === 'currency')
            val = event;
    ...
    checkIsNull(valueData) {
        ...
        if (!valueData.tarix  || valueData.tarix === 0
            || valueData.price === null || valueData.price === ''
            || !valueData.kassaBank || valueData.kassaBank.value === 0
            || !valueData.kassaBank2 || valueData.kassaBank2.value === 0
            || !valueData.kbType || valueData.kbType.value === 0
            || !valueData.kbType2 || valueData.kbType2.value === 0
            || !valueData.currency || valueData.currency.value === 0) {
            this.setState(Object.assign({}, this.state, {
                formData: Object.assign({}, this.state.formData, {
                    errors: Object.assign({}, this.state.formData.errors, {
                        tarixIsNull: !valueData.tarix || valueData.tarix === 0,
                        priceIsNull: valueData.price === null || valueData.price === '',
                        kassaBankIsNull:  !valueData.kassaBank || valueData.kassaBank.value === 0,
                        kassaBank2IsNull:  !valueData.  kassaBank2 || valueData.  kassaBank2.value === 0,
                        kbTypeIsNull:  !valueData.kbType || valueData.kbType.value === 0,
                        kbType2IsNull:  !valueData.kbType2 || valueData.kbType2.value === 0,
...
export default withStyles(styles)(connect(null, null)(KassaToKassa));
