...
import ItemCardAmountForm from "./TransDeleteAllForm";
...
import TransferFilter from "../taball/TransAllFilter";
import TransAllFilter from "../taball/TransAllFilter";
export function gridAddEditButton(data) {
    ...
    return (
        <div style={{display: 'flex', justifyContent: 'center',}}>
            ...
            {
                <Tooltip title="Восстановить" style={{paddingTop: 0, paddingBottom: 0}}>
                    <IconButton aria-label="Восстановить" onClick={() => onClick(id, 'delete')}>
...
class TransAll extends CoreComponent {
    constructor(props) {
        super(props);
        this.state = {
            processing: false,
                ...
                <Card style={{marginTop: "0px"}}>
                    ...
                    <CardBody>
                        ...
                        <DataGrid
                            ...
                            <Column dataField={'delete_user'} caption={'Удалил от пользователь'}/>
    ...
    addConfirmDialog = () => <SweetAlertConfirm
        ...
        dialogContent={'Вы уверены, что хотите это Восстановить? ?'}
        successContent={'Информация успешно Восстановить'}
...
export default withStyles(styles)(connect(null, null)(TransAll));
