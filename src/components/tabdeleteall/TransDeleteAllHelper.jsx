...
export const LOAD_DATA_URL = BACKEND_URL + '/api/itemcardamount/filterDatadeleteall';
...
export const DELETE_URL = BACKEND_URL + '/api/itemcardamount/deleterefund/{id}';
    ...
    return {
        ...
        action: (
            <div className="actions-right">
                               <Button justIconThin round simple onClick={() => onClick(id, 'delete')} color="info"
                        className="remove">
                    <Close/>
                </Button>
            </div>
