...
export const MODULE_NAME = 'Yerdəyişmə';
...
export const YERDEYISME = new ValueLabel(7, 'Yerdəyişmə');
...
export function createDataTitle(item, onClick) {
    ...
    return {
        ...
        sourceWarehouse: item.sourceWarehouse ? item.sourceWarehouse.label: '',
        destWarehouse: item.destWarehouse ? item.destWarehouse.label: '',
        action: (
