...
import YerdeyismeTitle from "./YerdeyismeTitle";
import YerdeyismeLines from "./YerdeyismeLines";
...
import {
    ...
    INSERT_URL,
    LOAD_DATA_URL,
    MODULE_NAME, YERDEYISME,
    DELETE_URL, LOAD_BY_ID_URL
} from './YerdeyismeHelper';
...
class Yerdeyisme extends Component {
    constructor(props) {
        super(props);
        this.state = {
            fakturaList: [],
            faktura: {
                ...
                tarix: 0,
                fakturaNo: '',
                fakturaType: YERDEYISME,
                sourceWarehouse: new ValueLabel(),
                destWarehouse: new ValueLabel(),
                fakturaItemList: [
                    {
                        id: 0,
                        amount: 0,
    ...
    addeditUi = classes => <Fragment>
        <YerdeyismeTitle valueData={this.state.faktura} onChange={this.handleOnChange} errors={this.state.errors}/>
        <Grid container>
            <Grid item xs={12}>
                <YerdeyismeLines
    ...
    checkIsNull = faktura => {
        const err = {};
        const {tarix, fakturaNo, sourceWarehouse, destWarehouse, fakturaItemList} = faktura;
...
export default withStyles(styles)(Yerdeyisme);
