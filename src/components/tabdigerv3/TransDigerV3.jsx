...
import ItemCardAmountForm from "./TransDigerV3Form";
...
import TransferFilter from "./TransferFilterV3";
...
class Trans1 extends CoreComponent {
        ...
        return (
            <Fragment>
                ...
                <TransferFilter
                    ...
                    onFilterClearButtonClick456={this.handleClearButtonClick456}
                ...
                <Card style={{marginTop: "0px"}}>
                    ...
                    <CardBody>
                        ...
                        <DataGrid
                            ...
                            <Column dataField={'currencyKassa'} caption={'Счет 1'}/>
    ...
    checkIsNull(valueData) {
        ...
        if (!valueData.mebleg || valueData.mebleg.value === 0
            ...
            || !valueData.client2 || valueData.client2.value === 0
            || !valueData.fakturaType2 || valueData.fakturaType2.value === 0
            || !valueData.currencyKassa || valueData.currencyKassa.value === 0) {
            this.setState(Object.assign({}, this.state, {
                formData: Object.assign({}, this.state.formData, {
                    errors: Object.assign({}, this.state.formData.errors, {
                        ...
                        client2IsNull: !valueData.client2 || valueData.client2.value === 0,
                        fakturaType2IsNull: !valueData.fakturaType2 || valueData.fakturaType2.value === 0,
                        currencyKassaIsNull: !valueData.currencyKassa || valueData.currencyKassa.value === 0,
                    })
                }),
