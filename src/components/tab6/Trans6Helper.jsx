...
export const MODULE_NAME = 'Начальные остатки клиентов';
export const LOAD_COMP_DATA_URL = BACKEND_URL + '/api/itemcardamount/compData';
export const LOAD_DATA_URL = BACKEND_URL + '/api/itemcardamount/filterData6';
...
export class ValueData {
    id = 0;
    fakturaType = new ValueLabel(10,"musteri qaliq");
