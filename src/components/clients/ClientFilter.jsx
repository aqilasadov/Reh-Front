...
function ClientFilter(props) {
    ...
    return (
        <ExpansionPanel defaultExpanded
            ...
            >
                <h4 className={classes.title}>Müştərilər üzrə axtarış</h4>
            </ExpansionPanelSummary>
            <ExpansionPanelDetails className={classes.expansionPanelDetails}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={xs}>
                        <CustomInput
                            id="companyName"
                            labelText={'Müəssisənin adı'}
                            formControlProps={{fullWidth: true}}
                            inputProps={{
                                onChange: onChange('companyName'),
                                name: 'companyName',
                                value: ifNull(data.companyName)
                            }}
                        />
                    </Grid>
                    ...
                    <Grid item xs={xs}>
                        <CustomSelect required
                                      ...
                                      name={'clientsType'}
                                      label="Müştəri növü"
                                      value={data.clientsType === null ? 0 : data.clientsType.value}
                                      data={compData.clientsTypeList}
                                      onChange={onChange('clientsType')}
                                      fullWidth/>
                    </Grid>
                </Grid>
...
export default withStyles(accordionStyle)(ClientFilter);
