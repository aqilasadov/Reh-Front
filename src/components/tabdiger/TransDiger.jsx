...
import ItemCardAmountForm from "./TransDigerForm";
...
class Trans1 extends CoreComponent {
    ...
    handleOnChange = name => event => {
        ...
        let yekundeger = 0;
        let qazanc = 0;
        if (name === 'fakturaType' || name === 'item' || name === 'unitsetGrp' || name === 'client' || name === 'client2' || name === 'branch' || name === 'currency'|| name === 'currencyKassa')
            val = event;
