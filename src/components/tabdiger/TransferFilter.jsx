...
function TransferFilter(props) {
    const {data, compData, onChange, onFilterButtonClick, onFilterClearButtonClick,onFilterClearButtonClick2,onFilterClearButtonClick22,onFilterClearButtonClick3,onFilterClearButtonClick4,onFilterClearButtonClick456} = props;
    const xs = 3;
        ...
        <ExpansionPanel defaultExpanded>
            ...
            <ExpansionPanelDetails>
                ...
                <Button justIconThin round simple
                        onClick={onFilterClearButtonClick456}
                        color="primary">
                    <Print/>
                    Ежедневный-Отчет клиента
                </Button>
