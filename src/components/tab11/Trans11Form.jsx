...
import {CompData, ValueData} from "./Trans11Helper";
    ...
    function content() {
        return (
            <Grid container spacing={1}>
                ...
                <Grid item xs={12} sm={5} style={{margin:0, paddingTop: '0px'}}>

                    <Autocomplete source={compData.clientList}
                                  id={'client'}
                                  name={'client'}
                                  value={valueData.client}
                                  placeholder={(valueData.id === 0)?'Кому':'Клиент'}
                                  textFieldProps={{
                                      label: (valueData.id === 0)?'Кому':'Клиент',
                                      InputLabelProps: {
                                          shrink: true,
                                      },
                ...
                {/*    <CustomInput*/}
                {/*        id="alan"*/}
                {/*        labelText={(valueData.id === 0)?'Alan şəxs':'Şəxs'}*/}
                {/*        formControlProps={{fullWidth: true}}*/}
                {/*        inputProps={{*/}
