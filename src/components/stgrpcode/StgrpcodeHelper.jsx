...
export const LOAD_DATA_URL = BACKEND_URL + '/api/stgrpcode/filterData';
export const LOAD_BY_ID_URL = BACKEND_URL + '/api/stgrpcode/{id}';
export const INSERT_URL = BACKEND_URL + '/api/stgrpcode/insupd';
export const DELETE_URL = BACKEND_URL + '/api/stgrpcode/delete/{id}';
