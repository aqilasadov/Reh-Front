...
import WarehouseForm from "./UnitsetGrpForm";
...
class UnitsetGrp extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            dataLoaded: false,
    ...
    addUnitsetGrp = () => {
        avrFetch(BACKEND_URL + "/api/unitsetGrp/generatecode")
    ...
    checkIsNull(valueData) {
        ...
        if (valueData.title === null || valueData.title === ''
            || valueData.code === null || valueData.code === '') {
            this.setState(Object.assign({}, this.state, {
                formData: Object.assign({}, this.state.formData, {
                    errors: Object.assign({}, this.state.formData.errors, {
                        titleIsNull: valueData.title === null || valueData.title === '',
...
export default withStyles(styles)(connect(null, null)(UnitsetGrp));
