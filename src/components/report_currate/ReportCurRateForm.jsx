...
import {CompData, ValueData} from "./ReportCurRateHelper";
...
function ReportCurRateForm(props) {
...
ReportCurRateForm.defaultProps = {
    open: true,
    onChange: () => {
    },
    dialogAction: () => {
...
export default withStyles(style)(ReportCurRateForm);
