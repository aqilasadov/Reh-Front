...
import {CompData, ValueData} from "./PartiyaHelper";
    ...
    function content() {
        return (<Grid container spacing={1}>
            ...
            <Grid item xs={12} sm={6} style={{margin:0, paddingTop: '0px'}}>
                ...
                <Autocomplete source={compData.xercList}

                              id={'xerc'}
                              name={'xerc'}
                              value={valueData.xerc}
                              placeholder={'Расходы'}
                              textFieldProps={{
                                  label: 'Расходы',
                                  InputLabelProps: {
                                  ...
                                  error: errors.xercIsNull,
                              }}
                              onChange={onChange('xerc')}/>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
                <CustomInput
                    ...
                    inputProps={{
                        onChange: onChange('siranomresi'),
                        name: 'siranomresi',
                        value: ifNull(valueData.siranomresi)
                    }}
                />
            </Grid>
            <Grid item xs={12} sm={6} style={{margin:0, paddingTop: '0px'}}>
