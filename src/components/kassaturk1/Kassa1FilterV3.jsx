...
function TransferFilter(props) {
    const {data, compData, onChange, onFilterButtonClick, onFilterClearButtonClick,onFilterClearButtonClick2,onFilterClearButtonClick244,onFilterClearButtonClick22,onFilterClearButtonClick3,onFilterClearButtonClick4} = props;
    const xs = 12;
        ...
        <ExpansionPanel defaultExpanded>
            ...
            <ExpansionPanelDetails>
                ...
                <Grid container spacing={1}>
                    ...
                    {/*    <Autocomplete source={compData.clientFilterList}*/}
                    {/*                  id={'client'}*/}
                    {/*                  name={'client'}*/}
                    {/*                  value={data.client}*/}
                    {/*                  textFieldProps={{*/}
                    ...
                    <Grid container xs={12} style={{marginTop: "16px"}}>
                        ...
                        <Grid item xs={1}>
                            <Typography align={'left'} variant="body1">Остатка</Typography>


                        </Grid>
                        <Grid item xs={6}>
                            <div style={{whiteSpace:"pre-wrap"}}>
                            <Typography  variant="body1">{compData.kassatr1} </Typography>
                            </div>
                        </Grid>
                    </Grid>
                ...
                <Button justIconThin round simple
                        onClick={onFilterClearButtonClick244}
                        color="primary">
                    <Print/>
                    Касса отчет реальный
                </Button>
