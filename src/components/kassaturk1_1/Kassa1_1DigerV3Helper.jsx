...
export const LOAD_DATA_URL = BACKEND_URL + '/api/itemcardamount/filterDatakt1_1';
export const LOAD_BY_ID_URL = BACKEND_URL + '/api/itemcardamount/kt1_1/{id}';
export const INSERT_URL = BACKEND_URL + '/api/itemcardamount/insupd4';
...
export function createData(item, onClick) {
    ...
    return {
        ...
        begdate_turk: item.begdate_turk === 0 ? '' : moment.unix(item.begdate_turk).format("DD/MM/YYYY"),
        qeyd_turk: item.qeyd_turk,
        action: (
...
export class FilterData {
    ...
    begdate = moment(new Date().setHours(-240, 0, 0)).unix();
...
export class ValueData {
    ...
    begdate_turk =moment(new Date()).unix();
    qeyd_turk = '';
}
