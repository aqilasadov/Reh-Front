...
import ItemCardAmountForm from "./Kassa1_1DigerV3Form";
...
import TransferFilter from "./Kassa1_1FilterV3";
...
class Trans1 extends CoreComponent {
        ...
        return (
            <Fragment>
                ...
                <TransferFilter
                    ...
                    onFilterClearButtonClick244={this.handleClearButtonClick244}
    ...
    handleClearButtonClick2 = () => {
        ...
        // } else {
            const params = {
                ...
                fileType: "PDF",
                requestParams: [
                    {name: "client_id", isSet: 1, value: 676},
                    {
                        name: "begin_date",
                        isSet: 1,
    ...
    checkIsNull(valueData) {
        ...
        if (!valueData.begdate_turk

         ) {
            this.setState(Object.assign({}, this.state, {
                formData: Object.assign({}, this.state.formData, {
                    errors: Object.assign({}, this.state.formData.errors, {
                        begdate_turkIsNull: !valueData.begdate_turk || valueData.begdate_turk.value === '',
                                           })
                }),
