...
import ItemCardAmountForm from "./ItemCardAmountForm";
...
class ItemCardAmount extends CoreComponent {
    constructor(props) {
        super(props);
        this.state = {
            processing: false,
    ...
    checkIsNull(valueData) {
        ...
        if (valueData.name === null || valueData.name === ''
            ...
            || !valueData.price || valueData.price.value === 0
            ...
            this.setState(Object.assign({}, this.state, {
                formData: Object.assign({}, this.state.formData, {
                    errors: Object.assign({}, this.state.formData.errors, {
                        ...
                        priceIsNull: !valueData.price || valueData.price.value === 0,
...
export default withStyles(styles)(connect(null, null)(ItemCardAmount));
