...
class Items extends React.Component {
    ...
    handleOnChange = name => event => {
        let val = (name === 'cardType' || name === 'stgrpcode'|| name === 'unitsetLine') ? event : event.target.value;
    ...
    addNewItems = () => {
        avrFetch(BACKEND_URL + "/api/items/generatecode")
            .then(validateResponse)
            .then(readResponseAsJSON)
            .then(
                (value) => {
    ...
    checkIsNull(valueData) {
        ...
        if (valueData.name === null || valueData.name === ''
           ...
           // || valueData.barcode === null || valueData.barcode === ''|| valueData.barcode.length !== 13
            || !valueData.stgrpcode || valueData.stgrpcode.value === 0
            ...
            this.setState(Object.assign({}, this.state, {
                formData: Object.assign({}, this.state.formData, {
                    errors: Object.assign({}, this.state.formData.errors, {
                      ...
                      //  barcodeIsNull: valueData.barcode === null || valueData.barcode === ''|| valueData.barcode.length !== 13,
                        stgrpcodeIsNull:  !valueData.stgrpcode || valueData.stgrpcode.value === 0,
...
export default withStyles(styles)(connect(null, null)(Items));
