...
import ItemCardAmountForm from "./ChatForm";
...
class Chat extends CoreComponent {
    constructor(props) {
        super(props);
        this.state = {
            processing: false,
                ...
                <Card style={{marginTop: "0px"}}>
                    <CardBody>
                        ...
                        >
                            ...
                            <Column dataField={'cgTitle'} caption={'Группы чатов'}/>
...
export default withStyles(styles)(connect(null, null)(Chat));
