...
import UnitsetLineForm from "./UnitsetLineForm";
...
class UnitsetLine extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            dataLoaded: false,
    ...
    addUnitsetLine = () => {
        avrFetch(BACKEND_URL + "/api/unitsetline/generatecode")
    ...
    handleOnChange = name => data => {
        const val = (name === 'unitsetGrp') ? data : data.target.value;
        this.setState(Object.assign({}, this.state, {
    ...
    checkIsNull(valueData) {
        ...
        if (valueData.name === null || valueData.name === ''
            ...
            || !valueData.unitsetGrp || valueData.unitsetGrp.value === 0) {
            this.setState(Object.assign({}, this.state, {
                formData: Object.assign({}, this.state.formData, {
                    errors: Object.assign({}, this.state.formData.errors, {
                        ...
                        unitsetGrpIsNull:  !valueData.unitsetGrp || valueData.unitsetGrp.value === 0,
                    })
                }),
...
export default withStyles(styles)(connect(null, null)(UnitsetLine));
